...
model=load(open('insurance.pkl','rb'))

st.header("Insurance Cost Prediction")
st.text("This is a Web App that tells you the predicted insurance cost.")
st.header("just fill in your information below")
st.text("The AdaBoost REgressmodel was used")

age=st.slider("Age",0,100)
sex=st.radio("Gender",("Male","Female","Trangender") ,key = "sex")
bmi=st.slider("Your BMI",0.0,70.0)
children=st.slider("How many children ?",0,10)
smoker= st.radio("Are You a Smoker?",('Yes','No'),key ="smoker")
region=st.radio("Your Region",('southwest','southeast','northwest','northeast'),key="region")
